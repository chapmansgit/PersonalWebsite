...
const RESUME_TEXT = `Hi. I'm Christian, known as Chap. I analyze data and build production tools with AI in Charlotte, North Carolina. I hold a B.S. in Data Science from UNC Charlotte. Before that I did kinesiology and psychology research at UNC Greensboro before switching to data. I work in Python and SQL for analysis and TypeScript when something needs to ship. I build with AI rather than just use it. Most of my production work is built with Claude. I built an MCP server in TypeScript that classifies Claude conversations across four behavioral dimensions and scores AI fluency in real time. I analyzed sixty-two thousand tech industry salaries using linear regression and Ridge regularization to model compensation patterns. I built a relational database and SQL reporting layer for a car dealership on Oracle LiveSQL. I studied COVID-era migration patterns in Charlotte using Census Bureau and NCDHHS data in pandas. I built a skill graph with live job match analysis against open roles at Charlotte companies. I hold certifications in Claude Code, the Anthropic API, and the AI Fluency Framework. I'm open to data and technology roles in Charlotte. Find me on LinkedIn or reach me at seven oh four nine nine eight eleven thirteen.`;
